...
local Themes = {
	...
	Dark = {
		...
		MinimiseAccent = Color3.fromRGB(255, 70, 70),
		Maximise = Color3.fromRGB(0,255,0),
		MaximiseAccent = Color3.fromRGB(70,255,70),
...
function Material.Load(Config)
	...
	function TabLibrary.New(TabConfig)
		...
		function OptionLibrary.Label(LabelConfig)
			...
			local LabeltextSide = LabelConfig.Side or "Left"
			local ShadowYes = LabelConfig.Shadow or false
			...
			if ShadowYes  == true then
				...
				ButtonShadow.ImageColor3 = ThisTheme.Button
				ButtonShadow.ImageTransparency = 1
				ButtonShadow.Parent = Label
				TweenService:Create(ButtonShadow, TweenInfo.new(0.5), {ImageTransparency = 0}):Play()
			end

			local LabelLabel = Objects.new("Label")
			LabelLabel.Text = LabelText
			LabelLabel.TextXAlignment = Enum.TextXAlignment[LabeltextSide]
			LabelLabel.TextColor3 = ThisTheme.ButtonAccent
			LabelLabel.Font = Enum.Font.GothamSemibold
			LabelLabel.TextSize = 14
			LabelLabel.ClipsDescendants = true
			...
			function LabelLibrary.SetText(Val)
				LabelLabel.text = Val
			end
